...
ActiveRecord::Schema.define(version: 20160702041529) do
  ...
  create_table "pages", force: :cascade do |t|
    t.string   "comic_shortname", null: false
  ...
  add_index "pages", ["comic_shortname"], name: "index_pages_on_comic_shortname", using: :btree
